...
This repo accompanies a series of blog posts, and the state you’re looking at, tag `step-4`, belongs to the fourth one, [Resource Locking with CouchDB and Svelte](https://neighbourhood.ie/blog/2025/01/08/resource-locking-with-couchdb-and-svelte).
